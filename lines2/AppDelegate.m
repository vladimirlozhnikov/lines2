...
//  lines2
//
//  Created by lozhnikov on 19.12.13.
...
-(void) directorDidReshapeProjection:(CCDirector*)director
{
	if(director.runningScene == nil) {
		...
		//[director runWithScene: [LinesScene scene]];
        [director runWithScene: [LinesScene scene]];
	}
}
@end
...
- (void) showMenu
{
    [self.director replaceScene:[MenuScene scene]];
}

- (void) showGame
{
    [self.director replaceScene:[LinesScene scene]];
}
